                        ...
                        <form role="form" method="POST" action="{{ route('register') }}" style="margin-top: -30px;">
                            ...
                            <div class="col-md-12">
                                    ...
                                    <div class="col-sm-12 {{ $errors->has('phone') ? ' has-error' : '' }}">
                                        <div class="form-group label-floating">
                                            <label class="control-label" for="phone"><i class="fa fa-mobile-phone"></i> Nomor HP</label>
                                            <input class="form-control" id="phone" type="phone" name="phone" value="{{ old('email') }}" required>
                                            @if ($errors->has('phone'))
                                                <span class="help-block">
